...
public class EmailService {
    ...
    public void SendEmail(String email, String subject, String message) throws UnirestException {
        ...
        if (!this.enabled) //chequea si esta habilitado
            return;

        JsonNode r;
        HttpResponse<JsonNode> request = Unirest.post("https://api.mailgun.net/v3/sandbox7589c87026914b9bae20222cbc4cc7db.mailgun.org/messages")
